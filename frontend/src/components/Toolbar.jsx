...
const Toolbar = ({ editor }) => {
  ...
  return (
    <div style={{ padding: '0 16px 12px 16px', background: '#f9fbfd' }}>
      ...
      {/* Alignment */}
      <DropdownLabel text={<span style={{display: 'flex'}}><AlignLeft size={16} /></span>} />
      <DropdownLabel text={<span style={{display: 'flex'}}><List size={16} /></span>} />
      <DropdownLabel text={<span style={{display: 'flex'}}><ListOrdered size={16} /></span>} />
